...
#if defined (HAVE_POW)
 {   printf("Now we HAVE_POW use the standard library. \n");
    double result = pow(base, exponent);
 }
#else
 {   printf("Now we HAVE_POW use our own Math library. \n");
...
#ifdef USE_MYMATH
    printf("Now we use USE_MYMATH our own Math library. \n");
    double result = power(base, exponent);
#else
