...
/*
    ...
    */
    ...
    typedef void* (*allocate_type1)() ;
    allocate_type1  allocator1 = (allocate_type1) ModuleManager::singleton()->get("libWindowManager.so" , "getModuleInfo") ;

    iris::ModuleInfo *moduleInfo = (iris::ModuleInfo *)allocator1() ;
    if (moduleInfo != NULL) 
    {
